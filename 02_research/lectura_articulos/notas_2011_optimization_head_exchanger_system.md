...
- **Tipo de hidruro:** LaNi₅ y variantes en polvo compactado
...
- **Descripción del sistema:** Reactor cilíndrico con intercambiador interno, tres diseños: tubular (19 tubos 10mm), placas (2mm espesor, 0.8m² área) y aletas (1mm espesor, 100/m densidad)
...
- **Temperatura (°C):** Operación típica: 20-150, Diseño: -20 a 200, ΔT máximo: 80
- **Presión de trabajo:** Operación: 30-50 bar, Máxima: 100 bar, Caída < 0.5 bar
- **Flujo (NL/min):** Refrigerante: 10-20 L/min, H₂: hasta 100 NL/min
...
- Distribución térmica: uniforme (ΔT < 10°C)
