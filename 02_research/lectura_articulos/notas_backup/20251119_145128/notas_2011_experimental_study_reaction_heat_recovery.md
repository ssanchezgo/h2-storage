# Experimental Study of Reaction Heat Recovery in Metal Hydride Systems
...
- **Autores:** Mellouli, S., Askri, F., Dhaou, H., Jemni, A., Ben Nasrallah, S.
- **Año:** 2011
...
- **Configuración del Reactor:** Sistema de dos reactores con intercambiador de calor espiral
- **Dimensiones:** No especificado
- **Capacidad de H₂:** No especificado

### Material de Almacenamiento

- **Material de Hidruro:** LaNi4.8Al0.2
...
3. La reducción en tiempos de operación del 15-25% justifica la implementación
...
**Estado:** Completado con plantilla estándar
**Próximas Acciones:** Análizar aplicabilidad de configuración espiral al diseño del proyecto
