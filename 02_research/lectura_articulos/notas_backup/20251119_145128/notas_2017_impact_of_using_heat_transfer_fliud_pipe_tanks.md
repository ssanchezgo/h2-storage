...
- **Autores:** Mellouli, S., Askri, F., Abhilash, E., Ben Nasrallah, S.
- **Año:** 2016
...
- **Configuración del Reactor:** Cilíndrica anular con tubos HTF integrados
...
- **Sistema de Transferencia de Calor:** - Contacto directo MH-PCM
- **Tipo de Aletas:** No especificado
- **Fluido Térmico:** No especificado

### Condiciones de Operación

- **Temperatura de Operación:** 388K
...
- **Temperatura (degC):** Inicial: 20 (293K), HTF: 20 (293K)
...
- **Cantidad H2:** Hmax capacidad según hidruro LaNi5
...
- MH (LaNi5): k=1.2 W/m*K (efectiva), cp según composición
...
- $\dot{m}_{H_2}$: Tasa de absorción H2
