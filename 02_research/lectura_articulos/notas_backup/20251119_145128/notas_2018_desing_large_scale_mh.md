# Design of Large-scale Metal Hydride Storage Systems
...
- **Autores:** Kumar, S., Kojima, Y., Dutta, I., Varma, A.
- **Año:** 2017
...
- **Configuración del Reactor:** Cilíndrica modular en paralelo
- **Dimensiones:** No especificado
- **Capacidad de H₂:** 1000 kg

### Material de Almacenamiento

- **Material de Hidruro:** Variable según aplicación (no especificado en resumen)
- **Cantidad de Hidruro:** 1000 kg
