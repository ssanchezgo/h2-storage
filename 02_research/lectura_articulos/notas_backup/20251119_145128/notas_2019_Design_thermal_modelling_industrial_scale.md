...
- **Configuración del Reactor:** Cilíndrica horizontal con tubos internos y aletas
- **Dimensiones:** No especificado
- **Capacidad de H₂:** No especificado

### Material de Almacenamiento

- **Material de Hidruro:** TiFe0.9Mn0.1 (aleación AB modificada con Mn mejora cinética 30-40% y reduce temperatura activación vs TiFe puro)
- **Cantidad de Hidruro:** 100 kg
