...
- **Configuración del Reactor:** Placas corrugadas paralelas tipo sandwich (stack)
- **Dimensiones:** No especificado
- **Capacidad de H₂:** No especificado

### Material de Almacenamiento

- **Material de Hidruro:** LaNi5 (aleación AB5 estándar, seleccionada por cinética rápida intrínseca permite demostrar beneficio EPHE sin limitación cinética MH)
...
- **Temperatura de Operación:** 72-75degC
- **Presión de Operación:** 8-12 bar
- **Tiempo de Absorción:** No especificado
- **Tiempo de Desorción:** No especificado
