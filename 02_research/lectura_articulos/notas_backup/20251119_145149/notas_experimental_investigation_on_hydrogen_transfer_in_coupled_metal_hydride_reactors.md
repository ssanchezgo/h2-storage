# Investigación Experimental sobre Transferencia de Hidrógeno en Reactores de Hidruro Metálico Acoplados
...
- **Sistema de Transferencia de Calor:** El sistema consta de tres reactores idénticos (R1, R2, R3) conectados en serie. Cada reactor representa un "módulo" de purificación.
