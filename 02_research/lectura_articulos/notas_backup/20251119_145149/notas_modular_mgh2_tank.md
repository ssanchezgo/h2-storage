# Tanque Modular de Demostración de MgH2
...
- **Configuración del Reactor:** Calentadores de disco insertados en perforaciones dentro del propio disco de MgH2.
...
- **Sistema de Transferencia de Calor:** Para la reacción exotérmica de absorción, el mismo serpentín dentro del difusor se utiliza para hacer circular aire y evacuar el exceso de calor, manteniendo la temperatura bajo control.
