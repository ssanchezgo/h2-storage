# Revisión de Técnicas de Gestión Térmica en Hidruros Metálicos
...
- **Configuración del Reactor:** tubular
...
- **Sistema de Transferencia de Calor:** * **Chaquetas de Agua (Water Jackets):** Rodear el reactor con una camisa por la que circula un fluido térmico.
- **Tipo de Aletas:** longitudinales
